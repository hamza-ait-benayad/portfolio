  ...
  return (
    <div className="relative inline-block mb-10">
      <a
        href={href}
        download
        className="group relative inline-block px-6 py-3 text-[16px] font-bold uppercase text-primary bg-transparent cursor-pointer transition-all duration-150 no-underline appearance-none focus:outline-none"
      >
